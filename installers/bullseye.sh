...
dependencies="ufw zip php-fpm sudo java-common libasound2 libx16 libxrender1 libxtst6 libfontconfig1"
getCaddy="true"
javaDeb="zulu16.30.15-ca-jre16.0.1-linux_amd64.deb"
if [[ $PWNOPANEL ]]; then
	dependencies="java-common libasound2 libx16 libxrender1 libxtst6 libfontconfig1"
	unset getCaddy
fi
if [[ ! $(which apt) ]]; then 
